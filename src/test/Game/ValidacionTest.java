...
public class ValidacionTest {
    ...
    @Test
    public void testTrueParaDosBienDosRegular() {
        boolean resultado = Validacion.bienRegularPosiblesCombinaciones(2, 2);
        boolean esperado = true;
        assertEquals(resultado, esperado);
    }

    @Test
    public void testTrueParaDosBienCeroRegular() {
        boolean resultado = Validacion.bienRegularPosiblesCombinaciones(2, 0);
        boolean esperado = true;
        assertEquals(resultado, esperado);
    }

    @Test
    public void testFalseParaTresBienUnoRegular() {
        boolean resultado = Validacion.bienRegularPosiblesCombinaciones(3, 1);
        boolean esperado = false;
        assertEquals(resultado, esperado);
    }

    @Test
    public void testFalseParaSieteBienUnoRegular() {
        boolean resultado = Validacion.bienRegularPosiblesCombinaciones(7, 1);
        boolean esperado = false;
        assertEquals(resultado, esperado);
    }
}